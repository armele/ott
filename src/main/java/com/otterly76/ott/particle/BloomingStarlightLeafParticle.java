...
public class BloomingStarlightLeafParticle extends TextureSheetParticle {
    private final float rollSpeed;

    protected BloomingStarlightLeafParticle(ClientLevel level, double x, double y, double z,
    ...
    public record Provider(SpriteSet sprites) implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType type, @NotNull ClientLevel level,
                                       ...
                                       double xd, double yd, double zd) {
            BloomingStarlightLeafParticle p = new BloomingStarlightLeafParticle(level, x, y, z, xd, yd, zd);
