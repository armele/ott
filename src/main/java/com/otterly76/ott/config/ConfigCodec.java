...
public record ConfigCodec(String commentA, String commentB, String commentC, String commentD, boolean breaksSeedParity) {
    ...
    public static final ConfigCodec DEFAULT = new ConfigCodec("If disabled, some mod compatibility features will be turned off to prioritize parity with vanilla seeds.", "The following features will break if disabled:", "- Custom wood type shipwrecks", "- Structure optimizations", true);
}
