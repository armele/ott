...
import com.otterly76.ott.neoforge.impl.data.*;
import com.otterly76.ott.neoforge.impl.event.NeoForgeModEvents;
import com.otterly76.ott.neoforge.impl.network.NetworkHandler;
import com.otterly76.ott.neoforge.impl.registry.*;
...
import com.otterly76.ott.worldgen.block.predicate.BlockStatePredicate;
import com.otterly76.ott.worldgen.block.predicate.InStructurePredicate;
import com.otterly76.ott.worldgen.block.predicate.MultipleOfPredicate;
import com.otterly76.ott.worldgen.block.predicate.RandomChancePredicate;
import com.otterly76.ott.worldgen.block.stateprovider.RandomBlockProvider;
...
import com.otterly76.ott.worldgen.density.WrappedMarkerDensityFunction;
...
import com.otterly76.ott.worldgen.placement.condition.*;
import com.otterly76.ott.worldgen.placement.modifier.ConditionPlacement;
import com.otterly76.ott.worldgen.placement.modifier.NoiseSlopePlacement;
import com.otterly76.ott.worldgen.placement.modifier.OffsetPlacement;
...
import com.otterly76.ott.worldgen.structure.pool.alias.RandomEntries;
import com.otterly76.ott.worldgen.structure.pool.element.DelegatingPoolElement;
import com.otterly76.ott.worldgen.structure.pool.element.legacy.GuaranteedPoolElement;
import com.otterly76.ott.worldgen.structure.pool.element.legacy.LimitedPoolElement;
import com.otterly76.ott.worldgen.structure.processor.*;
import com.otterly76.ott.worldgen.structure.processor.condition.*;
import com.otterly76.ott.worldgen.structure.processor.modifier.ApplyAll;
import com.otterly76.ott.worldgen.structure.processor.modifier.ApplyRandom;
...
import static com.otterly76.ott.neoforge.impl.data.OttWorldGenProvider.BUILDER;
...
public class Ott {
    ...
    public Ott(IEventBus modEventBus) {
        ...
        modEventBus.addListener(NeoForgeModEvents::registerLayers);
        modEventBus.addListener(NeoForgeModEvents::registerAttributes);
        modEventBus.addListener(NeoForgeModEvents::registerSpawnPlacements);
