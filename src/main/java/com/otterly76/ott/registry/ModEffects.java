...
import com.otterly76.ott.effect.BreathOfNautilusMobEffect;
...
public class ModEffects {
    ...
    public static final DeferredHolder<MobEffect, BreathOfNautilusMobEffect> BREATH_OF_NAUTILUS = EFFECTS.register("breath_of_nautilus", () -> new BreathOfNautilusMobEffect(MobEffectCategory.BENEFICIAL, 0x00C0E8));
