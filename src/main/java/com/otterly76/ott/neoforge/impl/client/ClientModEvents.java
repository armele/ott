...
import com.otterly76.ott.neoforge.impl.client.gui.TrashScreen;
import com.otterly76.ott.neoforge.impl.client.model.BookshelfModelProxy;
import com.otterly76.ott.neoforge.impl.client.render.PrismaticColorHandler;
import com.otterly76.ott.neoforge.impl.client.render.texture.FXAtlasSpriteSource;
import com.otterly76.ott.neoforge.impl.client.tooltip.ClientFoodTooltipComponent;
...
@EventBusSubscriber(modid = com.otterly76.ott.api.core.Constants.MOD_ID, value = Dist.CLIENT)
public class ClientModEvents {
    ...
    public static void register(IEventBus modBus) {
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::registerGuiLayers);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::onClientSetup);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::onRegisterSpriteLoader);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::registerParticleFactories);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::registerBlockColors);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::registerItemColors);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::registerMenuScreens);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::registerRenderers);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::registerLayerDefinitions);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::onRegisterAdditional);
        modBus.addListener(com.otterly76.ott.neoforge.impl.client.ClientModEvents::onModelBaking);
    }
