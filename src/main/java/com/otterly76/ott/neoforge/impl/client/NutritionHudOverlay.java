...
public class NutritionHudOverlay implements LayeredDraw.Layer {
    ...
    private static final ResourceLocation HUNGER_PREVIEW_HALF = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/hunger_preview_half");
    private static final ResourceLocation SATURATION_OVERLAY = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/saturation_overlay");
    private static final ResourceLocation SATURATION_OVERLAY_HALF = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/saturation_overlay_half");

    private static final ResourceLocation FOOD_EMPTY = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/food_empty");
    private static final ResourceLocation FOOD_FULL = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/food_full");
    private static final ResourceLocation FOOD_HALF = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/food_half");

    private static final ResourceLocation EXHAUSTION_OVERLAY = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/exhaustion_overlay");

    private static final ResourceLocation FOOD_EMPTY_ROTTEN = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/food_empty_rotten");
    private static final ResourceLocation FOOD_FULL_ROTTEN = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/food_full_rotten");
    private static final ResourceLocation FOOD_HALF_ROTTEN = ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "hud/food_half_rotten");
