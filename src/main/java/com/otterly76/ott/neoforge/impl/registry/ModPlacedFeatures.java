...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> GIANT_HOLLOW_ROOT_ARCH = registerKey(com.otterly76.ott.api.core.Constants.MOD_ID, "giant_hollow_root_arch");
    public static final ResourceKey<PlacedFeature> GIANT_HOLLOW_ROOT_SPIKE = registerKey(com.otterly76.ott.api.core.Constants.MOD_ID, "giant_hollow_root_spike");
