package com.otterly76.ott.block.hedge;
...
public final class ModHedgeVariants {
    ...
    public static final List<HedgeVariant> ALL = List.of(
            ...
            new HedgeVariant(
                    ...
                    ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "block/midnight_creep")
            ),
            new HedgeVariant(
                    "blooming_starlight",
                    ModParticle.BLOOMING_STARLIGHT_LEAF::get,
                    ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "block/blooming_starlight_creep")
            ),
            new HedgeVariant(
                    "blooming_midnight",
                    ModParticle.BLOOMING_MIDNIGHT_LEAF::get,
                    ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "block/blooming_midnight_creep")
            )
    );
