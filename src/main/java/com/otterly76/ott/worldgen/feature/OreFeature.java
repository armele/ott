...
public class OreFeature extends Feature<OreConfig> {
    ...
    public boolean place(FeaturePlaceContext<OreConfig> context) {
        ...
        float $$6 = (float)config.size() / 8.0F;
        int $$7 = Mth.ceil(((float)config.size() / 16.0F * 2.0F + 1.0F) / 2.0F);
        ...
        for(int x = minX; x <= minX + maxXZ; ++x) {
            for(int y = minZ; y <= minZ + maxXZ; ++y) {
                if (minY <= level.getHeight(Types.OCEAN_FLOOR_WG, x, y)) {
    ...
    protected boolean doPlace(WorldGenLevel level, RandomSource random, OreConfig config, double $$3, double $$4, double $$5, double $$6, double $$7, double $$8, int minX, int minY, int minZ, int maxXZ, int maxY) {
        int blocksPlaced = 0;
        ...
        for(int $$19 = 0; $$19 < $$17; ++$$19) {
            ...
            double $$24 = random.nextDouble() * (double)$$17 / (double)16.0F;
            double $$25 = ((double)(MathUtils.sin((float)Math.PI * $$20) + 1.0F) * $$24 + (double)1.0F) / (double)2.0F;
            $$18[$$19 * 4] = $$21;
            $$18[$$19 * 4 + 1] = $$22;
            $$18[$$19 * 4 + 2] = $$23;
            $$18[$$19 * 4 + 3] = $$25;
        ...
        for(int $$26 = 0; $$26 < $$17 - 1; ++$$26) {
            if (!($$18[$$26 * 4 + 3] <= (double)0.0F)) {
                for(int $$27 = $$26 + 1; $$27 < $$17; ++$$27) {
                    if (!($$18[$$27 * 4 + 3] <= (double)0.0F)) {
        ...
        try (BulkSectionAccess bulkSectionAccess = new BulkSectionAccess(level)) {
            for(int $$33 = 0; $$33 < $$17; ++$$33) {
                ...
                if (!($$34 < (double)0.0F)) {
                    ...
                    for(int x = $$38; x <= $$41; ++x) {
                        double $$45 = ((double)x + (double)0.5F - $$35) / $$34;
                        if ($$45 * $$45 < (double)1.0F) {
                            for(int y = $$39; y <= $$42; ++y) {
                                double $$47 = ((double)y + (double)0.5F - $$36) / $$34;
                                if ($$45 * $$45 + $$47 * $$47 < (double)1.0F) {
                                    for(int z = $$40; z <= $$43; ++z) {
                                        double $$49 = ((double)z + (double)0.5F - $$37) / $$34;
                                        if ($$45 * $$45 + $$47 * $$47 + $$49 * $$49 < (double)1.0F && !level.isOutsideBuildHeight(y)) {
