...
public class ModTreeDecoratorTypes {
    ...
    static {
        TREE_DECORATOR_TYPES = DeferredRegister.create(Registries.TREE_DECORATOR_TYPE, "minecraft");
        PALE_MOSS = TREE_DECORATOR_TYPES.register("pale_moss", () -> new TreeDecoratorType<>(PaleMossDecorator.CODEC));
        CREAKING_HEART = TREE_DECORATOR_TYPES.register("creaking_heart", () -> new TreeDecoratorType<>(CreakingHeartDecorator.CODEC));
    }
}