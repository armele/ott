package com.otterly76.ott.worldgen.blockentitymodifier;
...
public record ApplyAll(List<RuleBlockEntityModifier> modifiers) implements RuleBlockEntityModifier {
    public static final MapCodec<ApplyAll> CODEC = RecordCodecBuilder.mapCodec((instance) -> instance.group(RuleBlockEntityModifier.CODEC.listOf().fieldOf("modifiers").forGetter(ApplyAll::modifiers)).apply(instance, ApplyAll::new));
