...
public class TextureHelper {
    public static final ResourceLocation MOD_ICONS = ResourceLocation.fromNamespaceAndPath("hunger", "textures/icons.png");
    public static final ResourceLocation HUNGER_OUTLINE_SPRITE = ResourceLocation.fromNamespaceAndPath("hunger", "tooltip_hunger_outline");
