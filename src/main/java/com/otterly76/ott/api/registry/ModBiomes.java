...
public class ModBiomes {
    ...
    public static final ResourceKey<Biome> FLATNESS = ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "flatness"));
    public static final ResourceKey<Biome> FLATNESS_WATER = ResourceKey.create(Registries.BIOME, ResourceLocation.fromNamespaceAndPath(com.otterly76.ott.api.core.Constants.MOD_ID, "flatness_water"));
}
