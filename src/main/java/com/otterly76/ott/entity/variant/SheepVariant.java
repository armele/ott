...
public record SheepVariant(ModelAndTexture<ModelType> modelAndTexture, SpawnPrioritySelectors spawnConditions) implements PriorityProvider<SpawnContext, SpawnCondition> {
    public static final Codec<SheepVariant> CODEC = RecordCodecBuilder.create((instance) -> instance.group(
            ModelAndTexture.mapCodec(ModelType.CODEC, ModelType.NORMAL).forGetter(SheepVariant::modelAndTexture),
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, SheepVariant> STREAM_CODEC = ByteBufCodecs.registry(OttRegistryKeys.SHEEP_VARIANT);
