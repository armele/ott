...
public class OtterFollowOwnerGoal extends Goal {
    ...
    public OtterFollowOwnerGoal(TamableAnimal tamable, double speedModifier, float startDistance, float stopDistance) {
        ...
        // Removed the navigation type check that was causing Otter spawning to fail
    }
    ...
    public boolean canContinueToUse() {
        if (this.navigation.isDone() || this.owner == null) {
            return false;
        } else {
