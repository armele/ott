...
public class OttWoodSetChestBoatEntity extends ChestBoat {
    private static final EntityDataAccessor<String> SET_NAME =
            SynchedEntityData.defineId(OttWoodSetChestBoatEntity.class, EntityDataSerializers.STRING);

    public OttWoodSetChestBoatEntity(EntityType<? extends Boat> type, Level level) {
        super(type, level);
    }
