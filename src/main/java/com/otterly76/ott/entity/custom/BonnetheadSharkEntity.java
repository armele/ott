...
public class BonnetheadSharkEntity extends AbstractFish implements GeoEntity {
    ...
    public BonnetheadSharkEntity(EntityType<? extends AbstractFish> type, Level level) {
        super(type, level);
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(ModItems.BONNETHEAD_SHARK_BUCKET.get());
    }
