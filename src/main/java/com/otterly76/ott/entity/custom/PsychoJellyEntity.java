...
public class PsychoJellyEntity extends AbstractFish implements GeoEntity {
    ...
    public PsychoJellyEntity(EntityType<? extends AbstractFish> type, Level level) {
        super(type, level);
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(ModItems.PSYCHO_JELLY_BUCKET.get());
    }
