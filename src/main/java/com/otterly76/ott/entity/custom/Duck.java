...
import com.otterly76.ott.entity.gecko.DuckGeoEntity;
...
public class Duck extends Chicken implements DuckGeoEntity {
    ...
    public void registerControllers(AnimatableManager.ControllerRegistrar controllers) {
        // Standard vanilla-style animations are often handled by GeckoLib's default behavior 
        // or manual bone manipulation in the model class if we want to match Chicken exactly.
    }
