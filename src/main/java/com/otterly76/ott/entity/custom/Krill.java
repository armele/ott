...
public class Krill extends AbstractSchoolingFish implements GeoEntity, Bucketable {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
    private static final EntityDataAccessor<Boolean> FROM_BUCKET = SynchedEntityData.defineId(Krill.class, EntityDataSerializers.BOOLEAN);

    private static final RawAnimation IDLE_ANIMATION = RawAnimation.begin().thenLoop("animation.krill.idle");
    private static final RawAnimation FLOP_ANIMATION = RawAnimation.begin().thenLoop("animation.krill.flop");

    public Krill(EntityType<? extends AbstractSchoolingFish> entityType, Level level) {
    ...
    public static boolean canSpawn(EntityType<Krill> type, LevelAccessor accessor, MobSpawnType reason, BlockPos pos, RandomSource random) {
