...
public class GuitarfishEntity extends AbstractFish implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    private static final RawAnimation SWIM_ANIMATION = RawAnimation.begin().thenLoop("Swim");
    private static final RawAnimation IDLE_ANIMATION = RawAnimation.begin().thenLoop("Idle");
    private static final RawAnimation LAND_ANIMATION = RawAnimation.begin().thenLoop("Land");

    public GuitarfishEntity(EntityType<? extends AbstractFish> type, Level level) {
        super(type, level);
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(ModItems.GUITARFISH_BUCKET.get());
    }
