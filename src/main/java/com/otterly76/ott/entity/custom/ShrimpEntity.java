...
public class ShrimpEntity extends AbstractSchoolingFish implements GeoEntity {
    ...
    public static boolean canSpawn(EntityType<ShrimpEntity> type, ServerLevelAccessor world, MobSpawnType reason, BlockPos pos, RandomSource random) {
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(ModItems.SHRIMP_SPAWN_EGG.get()); // FIXME: Should be a bucket if we add it
    }
    ...
    private PlayState predicate(AnimationState<ShrimpEntity> event) {
