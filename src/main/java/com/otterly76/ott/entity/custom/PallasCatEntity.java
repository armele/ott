...
public class PallasCatEntity extends Animal implements GeoEntity {
    private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);

    public PallasCatEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }
    ...
    public AgeableMob getBreedOffspring(@NotNull ServerLevel level, @NotNull AgeableMob other) {
        return ModEntities.PALLAS_CAT.get().create(level);
    }
