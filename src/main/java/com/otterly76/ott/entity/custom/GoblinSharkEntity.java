...
public class GoblinSharkEntity extends AbstractFish implements GeoEntity {
    ...
    public GoblinSharkEntity(EntityType<? extends AbstractFish> type, Level level) {
        super(type, level);
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(ModItems.GOBLIN_SHARK_BUCKET.get());
    }
