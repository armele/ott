...
public class Ghost extends Monster implements GeoEntity {
    ...
    protected SoundEvent getAmbientSound() {
        return com.otterly76.ott.sound.ModSounds.GHOST_AMBIENT.get();
    }

    @Override
    @NotNull
    protected SoundEvent getHurtSound(@NotNull DamageSource damageSource) {
        return com.otterly76.ott.sound.ModSounds.GHOST_HURT.get();
    }

    @Override
    @NotNull
    protected SoundEvent getDeathSound() {
        return com.otterly76.ott.sound.ModSounds.GHOST_DEATH.get();
    }
