...
public class SnakeEntity extends Animal implements GeoEntity {
    ...
    public SnakeEntity(EntityType<? extends Animal> type, Level level) {
        super(type, level);
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, MouseEntity.class, true));
    }
