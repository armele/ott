...
public class CichlidEntity extends AbstractFish implements GeoEntity {
    ...
    public CichlidEntity(EntityType<? extends AbstractFish> type, Level level) {
        super(type, level);
    ...
    public @NotNull ItemStack getBucketItemStack() {
        return new ItemStack(ModItems.CICHLID_BUCKET.get());
    }
