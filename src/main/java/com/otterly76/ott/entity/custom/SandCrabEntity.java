...
public class SandCrabEntity extends Animal implements NeutralMob, GeoEntity {

    private static final RawAnimation IDLE = RawAnimation.begin().thenLoop("idle");
    private static final RawAnimation WALK = RawAnimation.begin().thenLoop("walk");

    private static final EntityDataAccessor<Boolean> HAS_COCONUT =
            SynchedEntityData.defineId(SandCrabEntity.class, EntityDataSerializers.BOOLEAN);
    ...
    public SandCrabEntity(EntityType<? extends Animal> entityType, Level level) {
    ...
    protected @NotNull SoundEvent getAmbientSound() {
        return ModSounds.SAND_CRAB_AMBIENT.get();
    }

    @Override
    protected @NotNull SoundEvent getHurtSound(@NotNull DamageSource source) {
        return ModSounds.SAND_CRAB_HURT.get();
    }

    @Override
    protected @NotNull SoundEvent getDeathSound() {
        return ModSounds.SAND_CRAB_DEATH.get();
    }
    ...
    static class CrabMeleeAttackGoal extends MeleeAttackGoal {
        private final SandCrabEntity crab;

        CrabMeleeAttackGoal(SandCrabEntity mob, double speedModifier, boolean followIfNotSeen) {
    ...
    static class CrabHurtByTargetGoal extends HurtByTargetGoal {
        ...
        CrabHurtByTargetGoal(SandCrabEntity mob) {
            super(mob);
            this.crab = mob;
        }
    ...
    static class CrabAvoidGoal<T extends LivingEntity> extends AvoidEntityGoal<T> {
        ...
        CrabAvoidGoal(SandCrabEntity mob, Class<T> entityClass, float maxDist, double walkSpeed, double sprintSpeed) {
    ...
    static class CrabNearestAttackableTargetGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {
        ...
        CrabNearestAttackableTargetGoal(SandCrabEntity mob, Class<T> targetType, int interval,
