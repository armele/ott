...
public class StingrayEntity extends AbstractFish implements GeoEntity {
    ...
    public static boolean canSpawn(EntityType<StingrayEntity> type, LevelAccessor accessor, MobSpawnType reason, BlockPos pos, RandomSource random) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(1, new BottomSwimGoal(this, 1.0, 10, 12));
    ...
    @Override
    protected @NotNull SoundEvent getHurtSound(@NotNull DamageSource p_28281_) {
