...
public class CapybaraAI {
    private static final ImmutableList<SensorType<? extends Sensor<? super CapybaraEntity>>> SENSOR_TYPES = ImmutableList.of(
            ...
            SensorType.HURT_BY,
            ModSensorTypes.CAPYBARA_TEMPTATIONS.get(),
    ...
    private static void initIdleActivity(Brain<CapybaraEntity> brain) {
        brain.addActivity(
                ...
                ImmutableList.of(
                        ...
                        Pair.of(1, new AnimalMakeLove(ModEntities.CAPYBARA.get(), 1.0F, 1)),
                        Pair.of(
                                2,
                                new RunOne<>(
                                        ImmutableList.of(
    ...
    public static Predicate<ItemStack> getTemptations() {
        return stack -> stack.is(ModTags.ItemTags.CAPYBARA_FOOD);
    }
}