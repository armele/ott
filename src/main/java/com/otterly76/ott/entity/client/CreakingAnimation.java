...
public class CreakingAnimation {
    public static final AnimationDefinition CREAKING_WALK;
    public static final AnimationDefinition CREAKING_ATTACK;
    public static final AnimationDefinition CREAKING_INVULNERABLE;
    public static final AnimationDefinition CREAKING_DEATH;

    static {
        CREAKING_WALK = Builder.withLength(1.125F)
                .looping()
                ...
                .addAnimation("right_leg", new AnimationChannel(Targets.POSITION,
                        ...
                        new Keyframe(1.125F, KeyframeAnimations.posVec(0.0F, 0.9674F, -3.6578F), Interpolations.LINEAR))).build();
        CREAKING_ATTACK = Builder
                .withLength(0.7083F)
                .looping().addAnimation("upper_body", new AnimationChannel(Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), Interpolations.LINEAR),
                ...
                .addAnimation("upper_body", new AnimationChannel(Targets.SCALE,
                        new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), Interpolations.LINEAR),
                        new Keyframe(0.7083F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), Interpolations.LINEAR)))
                .addAnimation("head", new AnimationChannel(Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), Interpolations.LINEAR),
                ...
                .addAnimation("head", new AnimationChannel(Targets.SCALE,
                        new Keyframe(0.1667F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), Interpolations.LINEAR),
                        new Keyframe(0.4167F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), Interpolations.LINEAR),
                        new Keyframe(0.5F, KeyframeAnimations.scaleVec(1.0F, 1.3F, 1.0F), Interpolations.LINEAR),
                        new Keyframe(0.625F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), Interpolations.LINEAR)))
                .addAnimation("right_arm", new AnimationChannel(Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), Interpolations.LINEAR),
                ...
                .addAnimation("left_arm", new AnimationChannel(Targets.POSITION,
                        ...
                        new Keyframe(0.7083F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), Interpolations.LINEAR)))
                .build();
        CREAKING_INVULNERABLE = Builder.withLength(0.2917F)
                ...
                .addAnimation("left_arm",
                        new AnimationChannel(Targets.POSITION,
                                new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), Interpolations.LINEAR),
                                new Keyframe(0.25F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), Interpolations.LINEAR))).build();
        CREAKING_DEATH = Builder.withLength(2.25F)
                .addAnimation("upper_body",
                        new AnimationChannel(Targets.ROTATION,
                                new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), Interpolations.LINEAR),
                ...
                .addAnimation("upper_body", new AnimationChannel(Targets.SCALE,
                        new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), Interpolations.LINEAR),
                        new Keyframe(0.0833F, KeyframeAnimations.scaleVec(1.0F, 1.1F, 1.0F), Interpolations.LINEAR),
                        new Keyframe(0.1667F, KeyframeAnimations.scaleVec(1.0F, 0.9F, 1.0F), Interpolations.LINEAR),
                        new Keyframe(0.2917F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), Interpolations.LINEAR)))
                .addAnimation("right_arm", new AnimationChannel(Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), Interpolations.LINEAR),
