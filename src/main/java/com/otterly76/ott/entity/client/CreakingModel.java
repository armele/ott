...
public class CreakingModel<T extends Creaking> extends HierarchicalModel<T> {
    ...
    public CreakingModel(ModelPart modelPart) {
        ...
        ModelPart modelPart3 = this.root.getChild("upper_body");
    ...
    public void setupAnim(Creaking creaking, float f, float g, float h, float i, float j) {
        ...
        this.animate(creaking.attackAnimationState, CreakingAnimation.CREAKING_ATTACK, (float)creaking.tickCount);
        this.animate(creaking.invulnerabilityAnimationState, CreakingAnimation.CREAKING_INVULNERABLE, (float)creaking.tickCount);
        this.animate(creaking.deathAnimationState, CreakingAnimation.CREAKING_DEATH, (float)creaking.tickCount);
    }
