...
public enum SortOrder {
    ...
    KEY_AZ("options.sortKeyAZ", entries -> entries.sort(Comparator.<IKeyEntry, String>comparing(o -> o.getKey().getTranslatedKeyMessage().getString()).thenComparing(o -> o.getKeyDesc().getString()))),
    KEY_ZA("options.sortKeyZA", entries -> entries.sort(Comparator.<IKeyEntry, String>comparing(o -> o.getKey().getTranslatedKeyMessage().getString(), Comparator.reverseOrder()).thenComparing(o -> o.getKeyDesc().getString(), Comparator.reverseOrder())));
    ...
    SortOrder(String key, ISort sorter) {
        this.sorter = sorter;
        this.display = Component.translatable("options.sort").copy()
                .append(": ")
