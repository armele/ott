...
import com.otterly76.ott.client.model.PenguinModel;
...
public class PenguinRenderer extends GeoEntityRenderer<PenguinEntity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, PenguinEntity animatable, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRerender, float partialTick, int packedLight, int packedOverlay, int colour) {
