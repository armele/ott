...
public class JellyfishModel extends GeoModel<JellyfishEntity> {
    @Override
    public ResourceLocation getModelResource(JellyfishEntity animatable, @Nullable GeoRenderer<JellyfishEntity> renderer) {
        return ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "geo/entity/jellyfish/jellyfish_1.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(JellyfishEntity animatable, @Nullable GeoRenderer<JellyfishEntity> renderer) {
