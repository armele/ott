...
public class ModItems {
    ...
    static {
        ...
        ModBlocks.WOOD_SETS.forEach((setName, setBlocks) -> {
            ...
            // Sign items (ott namespace) - mimic vanilla oak recipes & behavior (stack size 16)
            ...
            // Boat items (ott namespace) - proper per-set entities
            WOOD_SET_BOATS.put(setName, ITEMS.register(setName + "_boat",
                    () -> new ModBoatItem(
                            ModEntities.WOOD_SET_BOATS.get(setName),
                            new Item.Properties().stacksTo(1),
                            boat -> {
                                if (boat instanceof com.otterly76.ott.entity.OttWoodSetBoatEntity b) {
                                    b.setWoodSetName(setName);
                                }
                            }
                    )));
            ...
            WOOD_SET_CHEST_BOATS.put(setName, ITEMS.register(setName + "_chest_boat",
                    () -> new ModBoatItem(
                            ModEntities.WOOD_SET_CHEST_BOATS.get(setName),
                            new Item.Properties().stacksTo(1),
                            boat -> {
                                if (boat instanceof com.otterly76.ott.entity.OttWoodSetChestBoatEntity b) {
                                    b.setWoodSetName(setName);
                                }
                            }
                    )));
